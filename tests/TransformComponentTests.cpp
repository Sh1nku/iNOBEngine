...
TEST(TransformComponentTest, SetLocalPositionOnParent) {
	...
	obj->transform->SetLocalPosition(&b2Vec2(10, 0));
	obj->transform->SetLocalPosition(&b2Vec2(5, 0));
...
TEST(TransformComponentTest, SetLocalPositionOnParentWhenChildHasPosition) {
	GameObject *obj = new GameObject();
	obj->transform->SetLocalPosition(&b2Vec2(2, 0));
	GameObject *obj2 = new GameObject(obj);
	obj2->transform->SetLocalPosition(&b2Vec2(-2, 0));
	obj->transform->SetLocalPosition(&b2Vec2(10, 0));
